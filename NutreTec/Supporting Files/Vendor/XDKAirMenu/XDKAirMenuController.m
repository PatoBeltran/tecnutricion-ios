...
- (void)openMenuAnimated
{
    [UIView animateWithDuration:0.3f animations:^{
        ...
        UIBezierPath *shadowPath = [UIBezierPath bezierPathWithRect:self.currentViewController.view.bounds];
        self.currentViewController.view.layer.masksToBounds = NO;
        self.currentViewController.view.layer.shadowColor = [UIColor grayColor].CGColor;
        self.currentViewController.view.layer.shadowOffset = CGSizeMake(5.0f, 13.0f);
        self.currentViewController.view.layer.shadowOpacity = 0.8f;
        self.currentViewController.view.layer.shadowPath = shadowPath.CGPath;
