...
class SlidingContainerViewController: UIViewController, UIScrollViewDelegate, SlidingContainerSliderViewDelegate {
    ...
    init (parent: UIViewController, contentViewControllers: [UIViewController], titles: [String], icons: [UIImage]) {
        ...
        sliderView = SlidingContainerSliderView (width: view.frame.size.width, titles: titles, icons: icons)
        sliderView.frame.origin.y = parent.view.frame.size.height - 150
